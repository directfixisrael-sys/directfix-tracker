...
interface RepairStore {
  ...
  activeTab: 'orders' | 'customers' | 'messages' | 'settings' | 'feedback' | 'analytics' | 'prices';
  isLoading: boolean;
  
  // Tab actions
  setActiveTab: (tab: 'orders' | 'customers' | 'messages' | 'settings' | 'feedback' | 'analytics' | 'prices') => void;
