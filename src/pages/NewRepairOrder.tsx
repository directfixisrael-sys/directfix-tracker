...
const NewRepairOrder = () => {
  ...
  return <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className={`flex-1 p-4 pb-24 overflow-y-auto transition-all duration-200 ${isAnimating ? 'opacity-0 translate-y-4' : 'opacity-100 translate-y-0'}`}>
        ...
        {/* Trust Badges - Google, Midrag, Facebook */}
        {step === 'model' && <div className="flex items-center justify-center gap-3 mb-4 animate-fade-in">
            {/* Google 5 Stars */}
            <div className="flex items-center gap-1.5 bg-card border border-border rounded-lg px-3 py-2 shadow-sm">
              ...
              <div className="flex items-center gap-0.5">
                ...
                <span className="text-[10px] text-muted-foreground font-medium mr-1">5.0</span>
              </div>
            </div>

            {/* Midrag Badge */}
            <div className="flex items-center gap-1.5 bg-card border border-border rounded-lg px-3 py-2 shadow-sm">
              <img src={midragLogo} alt="מידרג" className="h-5 w-auto" />
              <span className="text-[10px] text-muted-foreground font-medium">מידרג</span>
            </div>
