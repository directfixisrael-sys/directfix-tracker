            ...
            <div className="flex items-center justify-center gap-6">
              ...
              <div className="flex items-center gap-2 bg-card border border-border rounded-xl px-4 py-2.5 shadow-sm">
                ...
                <div className="flex flex-col items-start">
                  ...
                  <span className="text-[10px] text-muted-foreground font-medium">5.0 בגוגל</span>
                </div>
              </div>

              {/* Midrag Badge */}
              <div className="flex items-center gap-2 bg-card border border-border rounded-xl px-4 py-2.5 shadow-sm">
                <img src={midragLogo} alt="מידרג" className="h-8 w-auto" />
                <span className="text-[10px] text-muted-foreground font-medium leading-tight">מופיעים<br/>במידרג</span>
              </div>
            </div>
            {/* Smart AI Search */}
