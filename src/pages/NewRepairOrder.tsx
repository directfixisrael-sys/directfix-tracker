...
const NewRepairOrder = () => {
  ...
  return <div className="min-h-screen bg-background flex flex-col" lang="he">
      ...
      {step !== 'success' && step !== 'model' && step !== 'repair' && <div className="sticky bottom-0 left-0 right-0 bg-background/95 backdrop-blur-md border-t border-border p-4 safe-area-pb shadow-wolt-xl">
