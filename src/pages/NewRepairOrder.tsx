...
const repairInfoDescriptions: Record<string, { title: string; description: string }> = {
  'מסך מקורי': {
              ...
              {['model', 'repair', 'price', 'schedule', 'details'].map((s, i) => (
                <div 
                  ...
                  className={`h-1 flex-1 rounded-full transition-all duration-500 ${
                    ['model', 'repair', 'price', 'schedule', 'details'].indexOf(step) >= i 
                      ? 'bg-primary' 
                      : 'bg-muted'
                  }`}
                />
            ...
            <div className="grid grid-cols-2 gap-2 max-h-[55vh] overflow-y-auto pb-16">
              {filteredModels.map((model, index) => (
                <Card
                  ...
                  className="p-3 cursor-pointer hover:border-primary hover:shadow-lg transition-all duration-200 active:scale-95"
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {repair.description && (
                          <p className="text-muted-foreground text-xs">{repair.description}</p>
                        )}
                        {!isPhoneOnly && selectedModel && (
                          <p className="text-primary font-bold text-sm mt-0.5">₪{price}</p>
                        )}
                      </div>
                      {isPhoneOnly && (
        ...
        {step === 'price' && (
          <div className="space-y-5 animate-fade-in">
            <div className="text-center mb-6">
              ...
              <h2 className="text-lg font-bold mb-1">סיכום הזמנה</h2>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <Input
                  ...
                  type="tel"
                  className="h-10 text-sm rounded-xl text-left"
                  dir="ltr"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  placeholder="למשל: הרצליה, סוקולוב 15, דירה 4"
              ...
              <div>
                ...
                <Textarea
                  placeholder="למשל: קומה 3, יש אינטרקום, לחייג בהגעה..."
                  value={customerNotes}
